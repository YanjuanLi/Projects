...
public class ViewDocJPanel extends javax.swing.JPanel {
   ...
   // private Administrator admin;
    ...
    private String s;
    public ViewDocJPanel(JPanel container, NHSystem system,String s) {
        initComponents();
        ...
        for (Network network : system.getNetworkList()) {
            ...
            for (NursingHouse nursingHouse : network.getNursingHouseDirectory().getNursingHouseList()) {
                if(nursingHouse.getName().equals(s)){
                    for(DoctorAccount doctorAccount : nursingHouse.getDoctorAccountDirectory().getUserAccountList()){
                            txtName.setText(doctorAccount.getDoctor().getName());
                            txtName.setEditable(false);
                            txtAge.setText(String.valueOf(doctorAccount.getDoctor().getAge()));
                            txtAge.setEditable(false);
                            txtGender.setText(doctorAccount.getDoctor().getGender());
                            txtGender.setEditable(false);
                            txtHA.setText(doctorAccount.getDoctor().getHomeAddress());
                            txtHA.setEditable(false);
                            txtDep.setText(doctorAccount.getDoctor().getDepartment());
                            txtDep.setEditable(false);
                            txtPhoneNumber.setText(doctorAccount.getDoctor().getPhoneNumber());
                            txtPhoneNumber.setEditable(false);
                            txtPW.setText(doctorAccount.getPassword());
    ...
    private void initComponents() {
        ...
        lblTitle.setText("View Doctor Information");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtNH, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(216, 216, 216)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txtHA, javax.swing.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)
                                            .addComponent(txtDep)
                                            .addComponent(txtPW)))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(43, 43, 43)
        ...
        String password = String.valueOf(passwordCharArray);
            ...
            for (NursingHouse nursingHouse : network.getNursingHouseDirectory().getNursingHouseList()) {
             ...
             Pattern p = Pattern.compile("^\\d{10}$");
                           ...
                           }else{ if(Integer.parseInt(txtAge.getText())<25|| Integer.parseInt(txtAge.getText())>80){
                        ...
                        doctor.setDepartment(txtDep.getText());
