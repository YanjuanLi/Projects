...
public class ReceivedNotificationsJPanel extends javax.swing.JPanel {
    ...
    public ReceivedNotificationsJPanel(JPanel container, NursingWorkerAccount nursingWorkerAccount, NHSystem system,String institution) {
        initComponents();
        ...
        for(Network network:system.getNetworkList()){
            for(NursingHouse nh:network.getNursingHouseDirectory().getNursingHouseList()){
                ...
                for(Notification n:nh.getNotificationDirectory().getNotificationList()){
                 if(n.getReceiverIdentity().equals("Nursing Worker")){//&&n.getReceiverID()==nursingWorkerAccount.getNursingWorker().getId()){
                    for(int i=0;i<n.getReceiverList().size();i++){
                        if(n.getReceiverList().get(i)==nursingWorkerAccount.getNursingWorker()){
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(nhText, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
