...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public ManageUserAccountJPanel(JPanel container, NursingHouse enterprise, String institution) {
        initComponents();
    ...
    public void populateEmployeeComboBox(Organization organization){
        ...
        for (Doctor employee : organization.getDoctorDirectory().getDoctorList()){
    ...
    public void popData() {
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
            for (DoctorAccount ua : organization.getDoctorAccountDirectory().getUserAccountList()) {
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        organization.getDoctorAccountDirectory().createDoctor(userName, password, employee, role,institution);
