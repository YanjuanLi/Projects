...
public class NursingWorkerRole extends Role {
    ...
    @Override
    public JPanel createWorkArea(JPanel userProcessContainer, DoctorAccount account,NursingWorkerAccount nwAccount, AdministratorAccount adminAccount,ElderAccount elderAccount, SystemAdminAccount systemAdminAccount, Organization organization,String s, NursingHouse enterprise, NHSystem business) {
        return new NursingWorkersJPanel(userProcessContainer,nwAccount,s,business);
    }
